...
@Component({
  selector: 'app-emp-cmplt-grid',
  templateUrl: './emp-cmplt-grid.component.html',
  styleUrls: ['./emp-cmplt-grid.component.css']
})
export class EmpCmpltGridComponent implements OnInit {
