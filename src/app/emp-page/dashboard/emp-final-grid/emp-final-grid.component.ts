...
@Component({
  selector: 'app-emp-final-grid',
  templateUrl: './emp-final-grid.component.html',
  styleUrls: ['./emp-final-grid.component.css']
})
export class EmpFinalGridComponent implements OnInit {
