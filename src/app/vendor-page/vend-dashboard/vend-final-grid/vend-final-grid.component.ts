...
@Component({
  selector: 'app-vend-final-grid',
  templateUrl: './vend-final-grid.component.html',
  styleUrls: ['./vend-final-grid.component.css']
})
export class VendFinalGridComponent implements OnInit {
